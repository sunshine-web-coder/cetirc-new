        ...
        <div className="container">
          <div className="relative z-10 text-center mb-[40px]">
            <h2 className="section-title mb-[20px]">
              <span className="font-normal">What Is</span> Alice 1 and Alice 2?
            </h2>
            <p>Alice 1 and Alice 2 are Cetirc’s cutting-edge palm vein solutions advancing the frontiers of secure biometrics payments and identification with eagle-eye accuracy.</p>
          </div>
