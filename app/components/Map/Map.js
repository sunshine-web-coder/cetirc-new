...
const SearchResultItem = ({ item }) => {
    const addressParts = [
        ...
        item.city,
        item.zip
    ].filter(part => part); // Filter out any falsy values
                  ...
                  <div className='relative z-10'>
                      ...
                      <div className='mb-[20px]'>
                          <div className="form-group relative">
                            ...
                            <input
                                className='leading-[53px] border border-[#E0DDDD] rounded-[9px] w-full pl-[60px] px-[25px] text-[16px] font-inter bg-[#F9F9F9]'
                                type="search"
                                name="search"
                                id="search"
