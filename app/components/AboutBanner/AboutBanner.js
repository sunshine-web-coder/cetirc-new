      ...
      <section className='banner-area relative z-10 overflow-hidden pt-[150px]'>
        <div className='container relative z-30'>
          <div className="text-center">
            <h1 className="main-title !leading-[1.4] sm:!leading-[1.2] md:mb-[15px] mb-[10px]"><span className="xl:text-[48px] lg:text-[36px] text-[26px] font-normal">The Secure Way to Identify and</span> <br /> Pay for Anything</h1>
