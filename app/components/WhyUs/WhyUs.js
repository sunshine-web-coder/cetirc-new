        ...
        <div className="container">
          <div className="flex flex-col items-center text-center lg:mb-[50px] mb-[30px]">
            <h2 className="section-title md:mb-[20px] mb-[10px]">
              <span className="font-normal">Why Cetirc’s</span> <br /> Palm Vein Solutions?
            </h2>
            <p className="max-w-[830px]">Our palm vein solutions outperform traditional authentication and verification methods, such as passwords, PINs, or fingerprint scans.</p>
          </div>
          <div className="grid lg:grid-cols-3 md:grid-cols-2 md:gap-[30px] gap-[20px]">
            ...
            <div className="bg-white py-[30px] px-[20px] rounded-[23px] text-center shadow-[0_30px_60px_rgba(0,0,0,0.05)]">
              ...
              <h3 className="xl:text-[30px] md:text-[24px] text-[20px] font-medium xl:mb-[30px] mb-[10px] leading-[1.3]">Very Secure</h3>
            ...
            <div className="bg-white py-[30px] px-[20px] rounded-[23px] text-center shadow-[0_30px_60px_rgba(0,0,0,0.05)]">
              ...
              <p className="">Unlike fingerprint or iris scans, our palm vein biometric system is noninvasive and does not require physical contact, which is more hygienic and convenient.</p>
            </div>
            {/* single box  */}
            <div className="bg-white py-[30px] px-[20px] rounded-[23px] text-center shadow-[0_30px_60px_rgba(0,0,0,0.05)]">
