                ...
                <div className="grid lg:grid-cols-[5fr_7fr] xl:gap-x-[100px] gap-x-[30px] md:pt-[110px] pt-[60px] pb-[45px]">
                    <div className='lg:mb-[0] mb-[40px]'>
                        ...
                        <div className="flex items-center gap-[20px]">
                            ...
                            <Link href="https://cetircstorage.s3.eu-north-1.amazonaws.com/Cetirc+-+Card+Dropdown+Removed.apk" className="bordered-btn !py-[10px] !px-[35px] !rounded-[8px]">Download app</Link>
                        </div>
                    </div>
