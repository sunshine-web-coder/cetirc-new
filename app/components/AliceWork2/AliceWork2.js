...
export default function AliceWork1() {
  return (
    <>
        <section className='md:pt-[50px] md:bg-[#F6FCEA] relative z-10 before:absolute before:bottom-0 before:left-0 before:h-[180px] before:w-full before:content-[""] before:bg-white before:-z-10'>
