                ...
                <div className="grid xl:grid-cols-3 sm:grid-cols-2 xl:gap-y-[60px] gap-y-[20px] xl:gap-x-[120px] gap-x-[20px]">
                    ...
                    <div className='md:text-left text-center'>
                        <div className="md:flex items-center gap-[20px] md:mb-[20px] mb-[8px]">
                            <Image className="lg:h-[70px] h-[60px] lg:w-[70px] w-[60px] lg:min-w-[70px] min-w-[60px] md:mx-0 mx-auto md:mb-0 mb-[20px]" src={ProductDetailsIcon1} alt="Product Details Icon"/>
                    ...
                    <div className='md:text-left text-center'>
                        <div className="md:flex items-center gap-[20px] md:mb-[20px] mb-[8px]">
                            <Image className="lg:h-[70px] h-[60px] lg:w-[70px] w-[60px] lg:min-w-[70px] min-w-[60px] md:mx-0 mx-auto md:mb-0 mb-[20px]" src={ProductDetailsIcon1} alt="Product Details Icon 1"/>
                    ...
                    <div className='md:text-left text-center'>
                        <div className="md:flex items-center gap-[20px] md:mb-[20px] mb-[8px]">
                            <Image className="lg:h-[70px] h-[60px] lg:w-[70px] w-[60px] lg:min-w-[70px] min-w-[60px] md:mx-0 mx-auto md:mb-0 mb-[20px]" src={ProductDetailsIcon2} alt="Product Details Icon 2"/>
                    ...
                    <div className='md:text-left text-center'>
                        <div className="md:flex items-center gap-[20px] md:mb-[20px] mb-[8px]">
                            <Image className="lg:h-[70px] h-[60px] lg:w-[70px] w-[60px] lg:min-w-[70px] min-w-[60px] md:mx-0 mx-auto md:mb-0 mb-[20px]" src={ProductDetailsIcon3} alt="Product Details Icon 3"/>
                    ...
                    <div className='md:text-left text-center'>
                        <div className="md:flex items-center gap-[20px] md:mb-[20px] mb-[8px]">
                            <Image className="lg:h-[70px] h-[60px] lg:w-[70px] w-[60px] lg:min-w-[70px] min-w-[60px] md:mx-0 mx-auto md:mb-0 mb-[20px]" src={ProductDetailsIcon4} alt="Product Details Icon 4"/>
