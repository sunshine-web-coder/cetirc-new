  ...
  return (
    <>
      ...
      >
        ...
        <ul className="mt-5">
          <li>
            <Link href="https://cetircstorage.s3.eu-north-1.amazonaws.com/Cetirc+-+Card+Dropdown+Removed.apk" className="bordered-btn !py-[12px] !px-[25px] !text-[16px]" onClick={handleClose}>
              Download app
            </Link>
          </li>
        </ul>
